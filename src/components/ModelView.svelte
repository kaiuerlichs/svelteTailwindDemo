...
<div class="h-full w-full relative bg-black">
    <div class="absolute h-full w-full flex items-center justify-center text-white animate-pulse">
    ...
    />
    <div class="absolute top-10 right-10 backdrop-blur-sm bg-white/30 text-white rounded-[20px] z-20" on:click={clickHandler}>
